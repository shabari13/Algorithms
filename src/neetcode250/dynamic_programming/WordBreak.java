...
public class WordBreak {
     ...
     *
     * Determines if string 's' can be segmented into space-separated
     * words, all of which exist in 'wordDict'.
     *
     * dp[i] = true  →  the substring s[0..i-1] can be built from the dictionary
     * dp[0] = true  →  empty string base case (zero characters processed)
     *
     * For each position i (1..n):
     *   Try every possible "last word" ending at i.
